// Create a function for toggle the specific button

function RemoveActiveClass () {
    // console.log('please remove active class');
...
function loadVideo (videos) {
    ...
    displyVideo.innerHTML = "";
    
// check for empty array object based on id 
     if(videos.length == 0) {
            displyVideo.innerHTML = `
            ...
            return; // that means nicher kono code are excecute hobe ne 
        }
